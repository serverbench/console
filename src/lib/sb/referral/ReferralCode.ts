...
export default class ReferralCode {
    ...
    public readonly program: ReferralProgram | null
    public readonly code: string

    constructor(id: string, program: ReferralProgram | null, code: string) {
        this.id = id
    ...
    public static fromObj(obj: any, community: Community | null = null) {
        return new ReferralCode(obj.id, obj.program ? ReferralProgram.fromObj(obj.program, community) : null, obj.code)
    }

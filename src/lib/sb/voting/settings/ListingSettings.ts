...
export default class ListingSettings {
    ...
    constructor(community: Community, ranking?: VotingRankingSettings, streak?: VotingStreakSettings, primary?: VotingListSettings, secondary?: VotingListSettings) {
    ...
    public static fromObject(community: Community, obj: any) {
        const settings = new ListingSettings(community)
